...
export default function ChangeTraineeStatus({ username, currentStatus, onStatusChange, className = "" }) {
  ...
  return (
    <div className={`flex flex-col items-start ${className}`}>
        ...
        <div className="flex items-center space-x-3">
            <label className="text-sm font-medium text-gray-700">Estado de Socio:</label>
            <button
