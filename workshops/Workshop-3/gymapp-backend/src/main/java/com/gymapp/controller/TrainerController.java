...
public class TrainerController {
    ...
    @GetByIdOperation(summary = "Get assigned trainees", description = "Retrieves the list of trainees assigned to a trainer")
    ...
    public ResponseEntity<List<TrainerTrainingResponseDTO>> getTrainingsByCriteria(
        ...
        TrainerTrainingFilterDTO dto = new TrainerTrainingFilterDTO(username, periodFrom, periodTo, traineeName);
        return new ResponseEntity<>(trainerService.getTrainingsByCriteria(dto), HttpStatus.OK);
    }
}
